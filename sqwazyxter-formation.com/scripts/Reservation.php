...
class Reservation
{
    ...
    public function reservation(array $data){
        ...
        //requete insert
        $requete = "INSERT INTO reservation (nom, prenom, periode, salle, rdvFrm, email, tel, heureD, heureF, dateAdd, dateUpdate)
        VALUES ('".$this->get_nom()."', '".$this->get_prenom()."', '".$this->get_periode()."', '".$this->get_salle()."', '".$this->get_datereservation()."', '".$this->get_email()."', '".$this->get_tel()."', '".$this->get_heureD()."', '".$this->get_heureF()."', '".$dates."', '".$dates."')";
